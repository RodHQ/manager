...
class RegisterAnimesWindow:
    ...
    def create_widgets(self):
        ...
        self.label = tk.Label(self.root, text="Cadastrar Anime", font=("Helvetica", 16))
        self.label.pack(pady=20)

        self.nome_anime_label = tk.Label(self.root, text="Nome do Anime:")
        self.nome_anime_label.pack(pady=5)
        ...
        self.register_button = tk.Button(self.root, text="Cadastrar", command=self.add_anime)
    ...
    def add_anime(self):
        ...
        if nome_filme and pixels:
            ...
            if db.anime_exists(nome_filme):
                ...
                db.add_anime(nome_filme, pixels, date_added)
                messagebox.showinfo("Sucesso", "Anime cadastrado com sucesso!")
